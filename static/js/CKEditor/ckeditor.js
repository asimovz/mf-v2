...
(function () {
  ...
  (function () {
    ...
    CKEDITOR.tools = {
      ...
      transformPlainTextToHtml: function (a, e) {
        ...
        if (!b) {
          var d = /\n{2}/g;
          if (d.test(c)) var m = "\x3c" + g + "\x3e", p = "\x3c/" + g + "\x3e", c = m + c.replace(d, function () {
            return p + m
          }) + p
        }
        c = c.replace(/\n/g, "\x3cbr\x3e");
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      is: function () {
        ...
        if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
          ...
          var f = this.$.getBoundingClientRect(), h = e.$.documentElement, w = h.clientTop || d.$.clientTop || 0,
            p = h.clientLeft || d.$.clientLeft || 0, k = !0;
  ...
  (function () {
    ...
    var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, h = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(),
      g = CKEDITOR.dom.walker.temp(), m = function (a) {
    ...
    CKEDITOR.dom.range.prototype = {
      ...
      trim: function (a, b) {
        ...
        if (!this.collapsed) {
          ...
          var h = new CKEDITOR.dom.walker(h), q = CKEDITOR.dom.walker.bookmark(), F = CKEDITOR.dom.walker.bogus();
  ...
  (function () {
    ...
    function y(a) {
      var b = a.config, c = b.plugins, d = b.extraPlugins, f =
        b.removePlugins;
      if (d) var e = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(e, ""),
        c = c + ("," + d);
      if (f) var h = new RegExp("(?:^|,)(?:" + f.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(h, "");
  ...
  (function () {
    ...
    var M = /<(a|area|img|input|source)\b([^>]*)>/gi, t = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,
      C = /^(href|src|name)$/i, z = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
  ...
  (function () {
    ...
    function b(a) {
      var b = a.name, d = a.element, k = a.elementMode, g =
          a.fire("uiSpace", {space: "top", html: ""}).html, m = a.fire("uiSpace", {space: "bottom", html: ""}).html,
    ...
    K = function () {
      ...
      return {
        list: {
          ...
          function a(c) {
            var e =
              [], f, g = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), k = c.endPath().contains(d), n = {};
  ...
  (function () {
    ...
    CKEDITOR.on("instanceCreated", function (a) {
      ...
      c.on("contentDom", function () {
        ...
        var e = c.document, f = CKEDITOR.document, g = c.editable(), l = e.getBody(), t = e.getDocumentElement(),
          C = g.isInline(), m, r;
        ...
        var a = p ? function () {
          ...
          var b = function (b, c) {
            ...
            if (-1 == t || t == e.length - 1 && 0 > m) {
              ...
              e = d.childNodes;
              if (!h) return f =
                e[e.length - 1], f.nodeType != CKEDITOR.NODE_TEXT ? {container: d, offset: e.length} : {
                container: f,
    ...
    attachStyleStateChange: function (a, d) {
      ...
      b || (b = this._.styleStateChangeCallbacks = [], this.on("selectionChange", function (a) {
        for (var d = 0; d < b.length; d++) {
          var h = b[d], k = h.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
          h.fn.call(this, k)
        }
      }));
      b.push({style: a, fn: d})
        ...
        return {
          ...
          86, exec: function (a, b) {
            ...
            var d = this, e = "undefined" !== typeof b.notification ? b.notification : !0, h = b.type,
              f = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard, a.getCommandKeystroke(this)), n =
      ...
      $: function (a, b, c, m) {
        ...
        addBlock: function (a, b) {
          ...
          var l = this.element, e = this._.iframe,
            ...
            t = b.getDocumentPosition(f), f = r ? r.getDocumentPosition(f) : {x: 0, y: 0}, q = "rtl" == this._.dir,
  ...
  CKEDITOR.plugins.add("colorbutton", {
    requires: "panelbutton,floatpanel", init: function (d) {
      function t(a, e, g, r, l) {
        var n = new CKEDITOR.style(k["colorButton_" + e + "Style"]), m = CKEDITOR.tools.getNextId() + "_colorBox", p;
        l = l || {};
          ...
          addTarget: function (a, e) {
            a.on("contextmenu", function (a) {
              ...
              if (!e || !c) {
                ...
                var b = a.getTarget().getDocument(), d = a.getTarget().getDocument().getDocumentElement(),
  ...
  (function () {
    ...
    CKEDITOR.plugins.copyformatting = {
      ...
      commands: {
        copyFormatting: {
          exec: function (a, b) {
            var d = CKEDITOR.plugins.copyformatting, e = a.copyFormatting, c = b ? "keystrokeHandler" == b.from : !1,
              f = b ? b.sticky || c : !1, g = d._getCursorContainer(a), h = CKEDITOR.document.getDocumentElement();
      ...
      _getSelectedWordOffset: function (a) {
        ...
        function e(a,
          ...
          if (m) c ?
            n = 0 : (g = /([\.\b]*$)/, n = (k = g.exec(h)) ? k.index : h.length); else if (c && (n += 1, n > h.length)) return e(f);
      ...
      _filterStyles: function (a) {
        var b = CKEDITOR.tools.isEmpty, d = [], e, c;
        for (c = 0; c <
      ...
      _applyFormat: function (a, b) {
        var d = a.getSelection().getRanges()[0], e = CKEDITOR.plugins.copyformatting, c, f;
        if (!d) return !1;
        if (d.collapsed) {
          f =
  ...
  (function () {
    ...
    CKEDITOR.plugins.enterkey = {
      enterBlock: function (b,
        ...
        if (a = a || v(b)) {
          a = y(a);
          var f = a.document, k = a.checkStartOfBlock(), m = a.checkEndOfBlock(), l = b.elementPath(a.startContainer),
            c = l.block, n = d == CKEDITOR.ENTER_DIV ? "div" : "p", e;
          if (k && m) {
      ...
      requires: "clipboard", init: function (a) {
        ...
        a.on("paste", function (f) {
          var b = f.data,
            ...
            c = c || b.dataValue, g =
              {dataValue: c, dataTransfer: {"text/rtf": d}},
  ...
  CKEDITOR.plugins.add("scayt", {
    requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", onLoad: function (a) {
      ...
      var d = a.scayt, b = this.scaytMenuDefinition(a), e =
          {}, f = a.config.scayt_contextCommands.split("|"), g = c.getAttribute(d.getLangAttribute()) || d.getLang(), h,
        k, m;
      h = d.isScaytNode(c);
      k = d.isGraytNode(c);
  ...
  (function () {
    ...
    function v(a) {
      ...
      if (a.data.getTarget().getName && ("mouseup" === a.name || !B(a.data.getTarget()))) {
        var e = a.editor || a.listenerData.editor,
          h = e.getSelection(1), m = I(e), l = a.data.getTarget(), k = l && l.getAscendant({td: 1, th: 1}, !0),
          l = l && l.getAscendant("table", !0), f = {table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1};
        d(a, h, m, l) && y(e, !0);
    ...
    function N(a, b) {
      ...
      h.getById("cke_table_copybin") || (p = h.createElement(f), r = h.createElement(f),
        r.setAttributes({id: "cke_table_copybin", "data-cke-temp": "1"}), p.setStyles({
        position: "absolute",
        width: "1px",
        height: "1px",
        overflow: "hidden"
    ...
    q.prototype.getTableMap = function () {
      ...
      a:{
        b = this.cells.last;
        var c = b.getAscendant("table"), d = n(b), c = CKEDITOR.tools.buildTableMap(c),
          e;
    ...
    var G = {
      onPaste: function (a) {
        ...
        var d = a.editor, e = d.getSelection(), h = u(e), m = this.findTableInPastedContent(d, a.data.dataValue),
        ...
        var d, e = A(a.cells.first), h = a._getTable(), m = {}, l, k, f, p;
      ...
      getCellsBetween: x, keyboardIntegration: function (a) {
        ...
        c.attachListener(c, "keydown", function (a) {
          ...
          return function (l) {
            var k = l.data.getKey(),
              f, m = 37 === k || 38 == k, g, n, q;
            if (h[k] && (f = a.getSelection()) && f.isInTable() && f.isFake) if (g = f.getRanges(), n = g[0]._getTableElement(), q = g[g.length - 1]._getTableElement(), l.data.preventDefault(), l.cancel(), 8 < k && 46 > k) g[0].moveToElementEditablePosition(m ? n : q, !m), f.selectRanges([g[0]]); else {
  ...
  (function () {
    ...
    CKEDITOR.tools.extend(CKEDITOR.fileTools, {
      addUploadWidget: function (a, b, e) {
        var k = CKEDITOR.fileTools, c = a.uploadRepository, m = e.supportedTypes ? 10 : 20;
        if (e.fileToElement) a.on("paste", function (f) {
          f = f.data;
          var l = a.widgets.registered[b], g = f.dataTransfer, e = g.getFilesCount(), h = l.loadMethod ||
            "loadAndUpload", d, n;
          if (!f.dataValue && e) for (n = 0; n < e; n++) if (d = g.getFile(n), !l.supportedTypes || k.isTypeSupported(d, l.supportedTypes)) {
        ...
        CKEDITOR.tools.extend(e, {
          downcast: function () {
            ...
            var f =
                this, b = this.wrapper.findOne("[data-cke-upload-id]").data("cke-upload-id"), g = c.loaders[b],
              e = CKEDITOR.tools.capitalize, h, d;
            ...
            if ("" === b.trim()) a.widgets.del(this); else {
              var g = this == a.widgets.focused, e = a.editable(), h = a.createRange(), d, k;
