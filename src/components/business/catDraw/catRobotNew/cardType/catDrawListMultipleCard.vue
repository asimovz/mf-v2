	...
	<div :style="listStyle">
		<div style="padding: 16px 16px;">
			<div class="flex-center" style="justify-content: flex-start; ">
				...
				<m-radio :value="reply.cardWidth" @on-change="(val)=>{reply.cardWidth = val}" :options="widths"></m-radio>
			...
			<div v-show="reply.cardWidth != 'SMALL_WIDTH'" class="flex-center" style="justify-content: flex-start;">
				...
				<m-radio :value="reply.cardHeight" :options="heights" @on-change="onChange"></m-radio>
			...
			<div v-show="reply.cardWidth == 'SMALL_WIDTH'" class="flex-center" style="justify-content: flex-start;">
				<div class="single-card-title single-card-title-top">高：</div>
				<m-radio :value="reply.cardHeight" :options="heights1" @on-change="onChange"></m-radio>
				<!-- <RadioGroup v-model="reply.cardHeight" @on-change="onChange" >
		...
		<div style="border-top: 1px solid #EBEEF5; ">
				...
				<div style="border: 1px dashed #EBEEF5; margin-top: 16px;">
					<div class="flex-center instance-top" style="border-bottom: 1px solid #EBEEF5;">
						...
						<div>
							...
							<i @click="removeList(index)" class="el-icon-delete cursor-pointer"  style="font-size:16px;"></i>
						</div>
					</div>
					...
					<div style="padding: 16px; background: #FAFAFA;">
						...
						<div class="txt-limit-div txt-limit-div1" style="">
							<roInputAboutQuoteOne  :inputAboutQuoteOne="item" quoteKey='originalTitle' :nodeList="nodeList" :otherNodeList="otherNodeList" :nowNode="nowNode" :maxlength="24" :showQuote="pageParameters.showQuote" :showQuoteEmoji="true"></roInputAboutQuoteOne>
						</div>
					</div>
					<div class="flex-center" style="justify-content: flex-start; margin-bottom: 18px; position: relative;">
						...
						<div class="txt-limit-div1 text-description" >
							<roInputAboutQuoteOne :inputAboutQuoteOne="item" quoteKey='originalDescription' type="textarea" :nodeList="nodeList" :otherNodeList="otherNodeList" :nowNode="nowNode" :showQuote="pageParameters.showQuote" :showQuoteEmoji="true"></roInputAboutQuoteOne>
						</div>
					</div>
					<div class="flex-center" style="justify-content: flex-start; margin-bottom: 18px; position: relative;">
								...
								<div @click="openMaterialModal(index)" class="flex-center" style="width: 141px; height: 78px; flex-direction: column; background: #FAFAFA;">
						          ...
						          <div class="play-icon">
									...
									<template v-else >
											...
											<i class="el-icon-plus" style="color: #260000;font-size:30px;"></i>
			...
			<div style="padding: 0 16px;">
				<div v-if="!showMaxCardsTishi"  @click="clickAll" data-type="addList" class="flex-center cursor-pointer add-button" style="border: 1px dashed #EBEEF5; margin: 16px 0;">
					...
					<i class="el-icon-plus" style="font-size:20px;margin-right: 6px;"></i>
					添加卡片
				</div>
