		...
		<div style="padding: 16px 16px;">
					<div class="flex-center" style="justify-content: flex-start; margin-bottom: 18px; position: relative;">
						...
						<div class="txt-limit-div txt-limit-div1" style="">
							<roInputAboutQuoteOne :inputAboutQuoteOne="reply.card" quoteKey='originalTitle' :nodeList="nodeList" :otherNodeList="otherNodeList" :nowNode="nowNode" :maxlength="24" :showQuote="pageParameters.showQuote" :showQuoteEmoji="true"></roInputAboutQuoteOne>
						</div>
					</div>
					...
					<div class="flex-center" style="justify-content: flex-start; margin-bottom: 18px; position: relative;">
						...
						<div class="txt-limit-div1 text-description" >
							<roInputAboutQuoteOne :inputAboutQuoteOne="reply.card" quoteKey='originalDescription' type="textarea" :nodeList="nodeList" :otherNodeList="otherNodeList" :nowNode="nowNode" :showQuote="pageParameters.showQuote" :showQuoteEmoji="true"></roInputAboutQuoteOne>
						</div>
					</div>
					<div class="flex-center" style="justify-content: flex-start; margin-bottom: 18px; position: relative;">
					...
					<div class="flex-center" style="justify-content: flex-start; position: relative;">
						...
						<m-radio :value="reply.cardOrientation" :options="cardOrientations" @on-change="onChangeCardOrientations"></m-radio>
					</div>
					...
					<div v-show="reply.cardOrientation == 'VERTICAL'" class="flex-center" style="justify-content: flex-start;  position: relative;">
						...
						<m-radio :value="reply.height" :options="sizes" @on-change="onChange"></m-radio>
					</div>
